                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <td><?php echo $i;?></td>
                                        <td><?php echo $value->subform_name;?></td>
                                        <td><?php echo $value->variable_count;?></td>
                                        <td>
                                            <a href="<?php echo base_url("Form/Viewvariable/".$value->subform_id) ?>" class="label bg-light-blue"> Lihat <i class="fa fa-list-ol"></i></a>
                                            <a href="<?php echo base_url("Form/Editvariable/".$value->subform_id) ?>" class="label bg-aqua"> Edit <i class="fa fa-edit"></i></a>
